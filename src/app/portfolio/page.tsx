  ...
  return (
    <AnimatedSection>
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-center mb-2 text-stone-200 ">{t('portfolio_page.title')}</h1>
        <p className="text-lg text-center text-stone-200  mb-12">{t('portfolio_page.description')}</p>
